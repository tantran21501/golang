...
import (
	...
	_ "github.com/lib/pq" // include _ to program even not calling it directly
...
func main(){
	...
	if dbURL == ""{
		log.Fatal("DB_URL is not found in environemnt")
	}
	...
	// if err != nil {
	// 	log.Fatal("Can't create to db connection!")
	// }
